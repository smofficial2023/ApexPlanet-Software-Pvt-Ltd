# SUBHAJIT MONDAL — Data Analyst Internship Portfolio

> **Capstone Integration** of all four internship projects demonstrating end-to-end data analytics skills — from raw data to boardroom insights.

---

## 📌 Overview

This master repository consolidates my complete internship journey as a **Data Analyst**. Across four structured projects, I worked on real business datasets — cleaning messy data, writing SQL queries, building dashboards, and presenting actionable insights to stakeholders.
...
| 03 | 📊 Dashboard Development | Built interactive Power BI & Tableau dashboards with drill-down & slicers | [→ View Repo](https://github.com/smofficial2023/ApexPlanet-Software-Pvt-Ltd/tree/main/Task%203) |
| 04 | 🎯 Insights & Presentation | Synthesised findings into a stakeholder-ready deck with recommendations | [→ View Repo](https://github.com/smofficial2023/ApexPlanet-Software-Pvt-Ltd/tree/main/Task4) |
...
1. **Real-world data is always messy** — I learned to audit before cleaning, and document every transformation made.
2. **SQL is the analyst's superpower** — Window functions and CTEs unlocked insights without needing Python at all.
3. **Dashboards are conversations** — Great dashboards anticipate what a manager will ask next and let them explore independently.
4. **Insights need context** — Every number needs a "so what?" framed in terms of revenue, risk, or opportunity.
5. **Documentation is a deliverable** — Code without comments and reports without methodology are incomplete work.
6. **Iteration beats perfection** — Showing rough work early and refining with feedback consistently produced better outcomes.
...
| 02 | Agenda |
| 03–04 | Data Cleaning Findings |
| 05–06 | SQL Analysis Results |
| 07–08 | Dashboard Walkthrough |
| 09–10 | Real World Problems Solved |
| 11 | Recommendations |
